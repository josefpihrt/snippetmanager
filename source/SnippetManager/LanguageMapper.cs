...
namespace Pihrtsoft.Snippets
{
    ...
    {
        private static readonly Dictionary<string, Language> _mapTextToEnum = new Dictionary<string, Language>(StringComparer.OrdinalIgnoreCase)
        {
        ...
        private static readonly Dictionary<Language, string> _mapEnumToText = new Dictionary<Language, string>()
        {
